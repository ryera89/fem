...
//      double val = Kred(i,j).real();
//      if ( abs(val) < 1.0e-10) val = 0;
//       KredF(i,j) = val;
//    }
//}
...
//cout << setprecision(3) << KredF << endl;
...
//dfeast_syev(&uplo,&n,MredF.begin(),&n,fpm,&epsout,&loop,&emin,&emax,&m0,eigenvalues.begin(),eigenvectors.begin(),&m,res.begin(),&info);
