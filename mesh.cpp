...
//template<>
//rectangular_mesh<ELEMENT_TYPE::QUAD4>::rectangular_mesh(uint32_t dofxnode,double Lx, double Ly, uint32_t Nx,uint32_t Ny):
//m_dofxnode(dofxnode), m_element_number(Nx*Ny),m_nodes_number((Nx+1)*(Ny+1)),m_x_lenght(Lx),m_y_lenght(Ly),
//m_nodes_coordinates(m_nodes_number),m_element_connect(m_element_number,4)
//{
//    double dx = Lx/Nx;
//    double dy = Ly/Ny;
...
//}
//template<>
//rectangular_mesh<ELEMENT_TYPE::TRI3>::rectangular_mesh(uint32_t dofxnode,double Lx, double Ly, uint32_t Nx, uint32_t Ny,
//                                                       bool diag):m_dofxnode(dofxnode),m_element_number(2*Nx*Ny),m_nodes_number((Nx+1)*(Ny+1)),
//                                                                    m_x_lenght(Lx),m_y_lenght(Ly),
//                                                                    m_nodes_coordinates(m_nodes_number),
